...
<body>
		...
		<div id="goods-list">
			<div class="detail">
				...
				<div class="goods-info">
					<button data-price="1000" class="basket_btn">
						<i class="fa-solid fa-cart-arrow-down"></i>
					</button>
				</div>
			</div>
	...
	<footer>
		<div class="background">
			<a href="#" class="footerLogo"> <img src="/images/logo.png"
				alt="대부분은 버그입니다." class="logo-img2">
			</a>
			<p>copyright&copy; All rights reserved SH Delivery</p>
			<ul class="sns">
				<li><a href="#"><img src="/images/sns1.jpg" alt="sns이미지1"></a></li>
				<li><a href="#"><img src="/images/sns2.jpg" alt="sns이미지2"></a></li>
				<li><a href="https://open.kakao.com/o/sEZq8moc"><img
						src="/images/sns3.jpg" alt="sns이미지3"></a></li>
			</ul>
		</div>
	</footer>
