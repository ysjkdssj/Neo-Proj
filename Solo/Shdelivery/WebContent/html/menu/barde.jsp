...
<body>
	...
	<div class="container">
		...
		<div id="goods-list">
			<div class="detail">
				<img src="/images/menuimg2/barde1.jpg" alt="감자칩" class="img-test">
				<div class="goods-info">
					<button data-price="1500" class="basket_btn">
						<i class="fa-solid fa-cart-arrow-down"></i>
					</button>
				</div>
			</div>
			<!-- 상품 목록-->
			<div class="detail">
				<img src="/images/menuimg2/barde2.jpg" alt="미니 웨하스" class="img-test">
				<div class="goods-info">
