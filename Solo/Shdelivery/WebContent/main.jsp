    ...
    <body>
        <header>
            <div class="background">
                <a href="/main.jsp"><img src="/images/logimg/logo.png" alt="SH Delivery" id="logo-img"></a></h1>
                <nav>
                    <ul>
                        <li class="mainMenu">
                            <a href="#">로그인</a>
        ...
        <footer>
            <div class="background">
                ...
                <ul class="sns">
                    <li><a href="https://www.facebook.com/profile.php?id=100052563275398"><img src="/images/logimg/sns1.jpg" alt="sns이미지1"></a></li>
                    <li><a href="https://www.instagram.com/p/ChtmnZBhTnj/?igshid=YmMyMTA2M2Y="><img src="/images/logimg/sns2.jpg" alt="sns이미지2"></a></li>
